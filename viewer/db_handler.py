...
def make_relative_path(full_path, base_path):
    return os.path.relpath(full_path, base_path) # return a relative path to full_path either form curr directory or from an opgtional start dir (base_path)
